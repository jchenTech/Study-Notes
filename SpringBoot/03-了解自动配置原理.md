...
注意，当我们使用@EnableConfigurationProperties + @ConfigurationProperties时，其自动的帮我们把组件注册到了容器中，而@ConfigurationProperties只能开启配置绑定，不能注册到容器，因此需要@Component将其注册到容器，否则将会报错
