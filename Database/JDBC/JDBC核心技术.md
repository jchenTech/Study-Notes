...
- 持久化的主要应用是将内存中的数据存储在关系型数据库中，当然也可以存储在磁盘文件、XML数据文件中。
  ...
  ![数据持久化](https://raw.githubusercontent.com/jchenTech/images/main/img/20201026162834.png)
...
![JDBC程序编写步骤](https://raw.githubusercontent.com/jchenTech/images/main/img/20201026164631.png)
...
- 在 java.sql 包中有 3 个接口分别定义了对数据库的调用的不同方式：
  ...
  ![数据库调用接口](https://raw.githubusercontent.com/jchenTech/images/main/img/20201026183451.png)
