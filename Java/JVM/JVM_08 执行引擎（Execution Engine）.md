...
![img](https://user-gold-cdn.xitu.io/2020/6/8/1729333fda0586ed?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
- 当计算机执行高级语言编写的程序时，仍然需要把程序解释和编译成机器的指令码。完成这个过程的程序就叫做解释程序或编译程序。
   ![6](https://user-gold-cdn.xitu.io/2020/6/8/1729335b173e3d31?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
- 汇编过程：实际上指把汇编语言代码翻译成目标机器指令的过程。
   ![img](https://user-gold-cdn.xitu.io/2020/6/8/172933609774cda3?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

## 4. 解释器

  JVM设计者们的初衷仅仅只是单纯地为了**满足Java程序实现跨平台特性**，因此避免采用静态编译的方式直接生成本地机器指令，从而诞生了实现解释器在运行时采用逐行解释字节码执行程序的想法。 ![img](https://user-gold-cdn.xitu.io/2020/6/8/172933694cc12661?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
- 这个计数器就用于统计方法被调用的次数，它的默认阈值在Client模式 下是1500 次，在Server 模式下是10000 次。超过这个阈值，就会触发JIT编译。
...
- -Xmixed：采用解释器+即时编译器的混合模式共同执行程序。
   ![img](https://user-gold-cdn.xitu.io/2020/6/8/17293384f2fd17a7?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
- C2的优化主要是在全局层面，逃逸分析是优化的基础。基于逃逸分析在C2上有如下几种优化：（server模式下才会有这些优化，64位系统默认就是server模式）
  - 标量替换：用标量值代替聚合对象的属性值
